  ...
  switch (name) {
    ...
    case "InvalidParameterException":
      return {
        ...
        description:
          "Uno de los datos ingresados no es válido. Revisa el formulario e inténtalo de nuevo.",
        action: "Reintentar",
      };
    ...
    case "UserNotConfirmedException":
      return {
        ...
        description:
          "Tu cuenta aún no ha sido verificada. Revisa tu correo y confirma tu cuenta para continuar.",
        action: "Entendido",
      };
    case "CodeMismatchException":
      return {
        ...
        description:
          "El código que ingresaste no coincide. Revísalo e inténtalo de nuevo.",
        action: "Reintentar",
      };
    case "ExpiredCodeException":
      return {
        ...
        description:
          "El código de verificación ha expirado. Vuelve al registro para solicitar uno nuevo.",
        action: "Entendido",
      };
    case "UserNotFoundException":
      return {
        ...
        description:
          "No encontramos una cuenta con ese correo. Verifica que sea correcto o crea una cuenta nueva.",
        action: "Reintentar",
      };
    ...
    case "LimitExceededException":
      return {
        ...
        description:
          "Superaste el límite de intentos. Espera unos minutos antes de intentarlo de nuevo.",
        action: "Entendido",
      };
    default:
      return {
        ...
        description:
          "No pudimos procesar tu solicitud. Por favor inténtalo más tarde.",
        action: "Entendido",
      };
  }
}

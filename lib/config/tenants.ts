export type Benefit = {
  icon:
    "truck" | "shield-check" | "rotate-ccw" | "headphones" | "tag" | "clock";
  title: string;
  description: string;
};
...
export const DEFAULT_BENEFITS: Benefit[] = [
  {
    icon: "truck",
    title: "Envío gratis",
    description: "En pedidos desde S/ 99",
  },
  {
    icon: "shield-check",
    title: "Pago seguro",
...
export const DEFAULT_HERO: HeroConfig = {
  ...
  image:
    "https://images.unsplash.com/photo-1555529669-e69e7aa0ba9a?w=700&h=920&fit=crop&auto=format",
  stats: [
...
export const TENANTS: Record<string, TenantConfig> = {
  demo: {
    ...
    hero: {
      heading: "Redefine\nTu Estilo",
      description:
        "Descubre las últimas tendencias de la temporada. Moda que habla por ti.",
      ctaPrimaryLabel: "Comprar ahora",
      discountBadge: "50%",
      discountLabel: "Hasta 50% OFF",
      image:
        "https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?w=700&h=920&fit=crop&auto=format",
      stats: [
    ...
    promoBanner: {
      ...
      description:
        "Descubre las últimas tendencias de la temporada con hasta 30% de descuento.",
  ...
  beibeli: {
    ...
    hero: {
      heading: "El Regalo\nPerfecto",
      description:
        "Encuentra algo especial para cada persona. Envío gratis en tu primer pedido.",
      ctaPrimaryLabel: "Ver regalos",
      discountBadge: "30%",
      discountLabel: "Hasta 30% OFF",
      image:
        "https://images.unsplash.com/photo-1513885535751-8b9238bd345a?w=700&h=920&fit=crop&auto=format",
      stats: [
    ...
    benefits: [
      {
        icon: "tag",
        title: "Precios bajos",
        description: "Siempre las mejores ofertas",
      },
      {
        icon: "truck",
        title: "Envío express",
        description: "Recíbelo en 24 horas",
      },
      {
        icon: "rotate-ccw",
        title: "Devoluciones",
        description: "Sin preguntas, 15 días",
      },
      {
        icon: "clock",
        title: "Horario extendido",
        description: "Atención hasta las 10pm",
      },
    ],
    promoBanner: {
      ...
      ctaHref: "/catalog",
      image:
        "https://images.unsplash.com/photo-1513885535751-8b9238bd345a?w=800&h=400&fit=crop&auto=format",
    },
  },
};
